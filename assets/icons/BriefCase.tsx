...
export const BriefCase = (props: SvgProps) => {
    ...
    return (
        <Svg width={width} height={height} viewBox="0 -1 32 32" {...props}>

            <G id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd" sketch:type="MSPage">
                <G id="Icon-Set" sketch:type="MSLayerGroup" transform="translate(-204.000000, -204.000000)" fill="currentColor">
