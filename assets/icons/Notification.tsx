...
export const NotificationIcon = (props: SvgProps) => {
    ...
    return (
        <Svg width={width} height={height} viewBox="0 0 24 24" fill={'none'}  {...props}>
            <Path d="M15 19.25C15 20.0456 14.6839 20.8087 14.1213 21.3713C13.5587 21.9339 12.7956 22.25 12 22.25C11.2044 22.25 10.4413 21.9339 9.87869 21.3713C9.31608 20.8087 9 20.0456 9 19.25" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" />
